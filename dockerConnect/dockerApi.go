...
// NewConnection  connect to a localhost instance of docker and write pid files
func NewConnection(cfg map[string]Service, address string, pidPath string) Lib {
